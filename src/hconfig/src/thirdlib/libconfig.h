...
extern LIBCONFIG_API int config_setting_lookup_int(const config_setting_t *setting, 
                                                   const char *name, int *value);
extern LIBCONFIG_API int config_setting_lookup_int64(const config_setting_t *setting, 
                                                     const char *name, long long *value);
extern LIBCONFIG_API int config_setting_lookup_float(const config_setting_t *setting, 
                                                     const char *name, double *value);
extern LIBCONFIG_API int config_setting_lookup_bool(const config_setting_t *setting, 
                                                    const char *name, int *value);
extern LIBCONFIG_API int config_setting_lookup_string(const config_setting_t *setting, 
...
extern LIBCONFIG_API int config_setting_get_int_elem(const config_setting_t *setting, int idx);
extern LIBCONFIG_API long long config_setting_get_int64_elem(const config_setting_t *setting, int idx);
extern LIBCONFIG_API double config_setting_get_float_elem(const config_setting_t *setting, int idx);
extern LIBCONFIG_API int config_setting_get_bool_elem(const config_setting_t *setting, int idx);
extern LIBCONFIG_API const char *config_setting_get_string_elem(const config_setting_t *setting, int idx);

extern LIBCONFIG_API config_setting_t *config_setting_set_int_elem(config_setting_t *setting, 
                                                                   int idx, int value);
extern LIBCONFIG_API config_setting_t *config_setting_set_int64_elem(config_setting_t *setting, 
                                                                   int idx, long long value);
extern LIBCONFIG_API config_setting_t *config_setting_set_float_elem(config_setting_t *setting, 
                                                                   int idx, double value);
extern LIBCONFIG_API config_setting_t *config_setting_set_bool_elem(config_setting_t *setting, 
                                                                   int idx, int value);
extern LIBCONFIG_API config_setting_t *config_setting_set_string_elem(config_setting_t *setting, 
...
#define /* int */ config_setting_is_aggregate(/* const config_setting_t * */ S) \
...
#define /* config_setting_t * */ config_setting_parent(/* const config_setting_t * */ S)      \
                 ((S)->parent)

#define /* int */ config_setting_is_root(/* const config_setting_t * */ S)    \
...
extern LIBCONFIG_API config_setting_t *config_setting_get_elem(const config_setting_t *setting, 
                                                               unsigned int idx);
...
extern LIBCONFIG_API int config_setting_remove(config_setting_t *parent, const char *name);
extern LIBCONFIG_API int config_setting_remove_elem(config_setting_t *parent, unsigned int idx);
extern LIBCONFIG_API void config_setting_set_hook(config_setting_t *setting, void *hook);
...
extern LIBCONFIG_API config_setting_t *config_lookup_from(config_setting_t *setting, const char *path);

extern LIBCONFIG_API int config_lookup_int(const config_t *config, const char *path, int *value);
extern LIBCONFIG_API int config_lookup_int64(const config_t *config, const char *path,
                                             long long *value);
...
extern LIBCONFIG_API int config_lookup_string(const config_t *config, const char *path, 
                                              const char **value);

#define /* config_setting_t * */ config_root_setting(/* const config_t * */ C) ((C)->root)

#define  /* void */ config_set_default_format(/* config_t * */ C,       \
                                              /* short */ F) (C)->default_format = (F)

#define /* short */ config_get_default_format(/* config_t * */ C) ((C)->default_format)

#define /* void */ config_set_tab_width(/* config_t * */ C, /* unsigned short */ W) \
                                        (C)->tab_width = ((W) & 0x0F)
