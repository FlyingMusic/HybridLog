...
Config::Config(): _defaultFormat(Setting::FormatDefault){
...
void Config::readFile(const char *filename) throw(FileIOException, ParseException){
...
Setting & Config::lookup(const char *path) const throw(SettingNotFoundException){
...
bool Config::lookupValue(const char *path, unsigned long long &value) const throw(){
...
Setting::Setting(config_setting_t *setting) : _setting(setting){
...
Setting & Setting::operator[](int i) const throw(SettingTypeException, SettingNotFoundException){
...
bool Setting::lookupValue(const char *name, unsigned long long &value) const throw(){
